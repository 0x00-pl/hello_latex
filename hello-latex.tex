...
\makeindex % this document has index
\begin{document}
...
\section{special pages \& documents -- part 7}{
  \subsection{index term and reference}{
    usepackage \{makeidx\}\\
    example index\index{Index for Fourier Series} \\
...
\end{verbatim}
  ...
  \subsection{inputing: merge files}{
    {
\begin{verbatim}
\input{./a.tex}
\input{./b.tex}
\end{verbatim}
  ...
  \subsection{export to HTML}{
   use  TtH and Hyperlatex.
  }
}


\printindex % for print index generated by \index{...}
